...
export default async function SearchPage({
  ...
  if (
    paginateProps.pagesCount !== 0 &&
    searchParams.page > paginateProps.pagesCount
  ) {
    redirect(
      getPaginateUrl({
  ...
  const products: IProductSerialized[] =
    SerializationUtil.getSerializedProducts(
      docsToData<IProduct>(productsChunks[searchParams.page - 1])
    );
  ...
  return (
    <>
      ...
      <ContentContainer styleClass="flex flex-col items-center px-2">
        ...
        <div className="text-2xl self-start py-2">
          {TRANSLATES[LOCALE].searchResultsByRequest}: &quot;{searchParams.q}
          &quot;
        </div>
