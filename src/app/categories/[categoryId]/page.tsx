...
export default async function CategoriesOrProductsPage(
  ...
  paginateProps.pagesCount = getPagesCount(productsQuerySnapshot.docs.length, paginateProps.pageLimit);

  if (paginateProps.page > paginateProps.pagesCount) {
    redirect(`${RouterPath.CATEGORIES}/${categoryId}?page=1&pageLimit=${paginateProps.pageLimit}`);
  }
