    ...
    if (newSearch?.length > 2) {
      ...
      if (newData.length < 10) {
        ...
        if (productsQuerySnapshot.docs.length) {
          newData = [
            ...newData,
            ...docsToData<IProduct>(productsQuerySnapshot.docs),
          ];
        }
      }
      ...
      {resultsVisible ? (
        <div className="bg-white w-full border-2 rounded-md absolute top-[42px] shadow-md z-10">
          {loading ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-grow leading-normal">
                        ...
                        <div className="viewed-recently__card-title">
                          {title}
                        </div>
                      </div>
                      <div className="w-max text-pink-500 font-medium text-nowrap">
            ...
            <div className="w-full text-center text-lg font-medium py-2 shadow-md">
              {TRANSLATES[LOCALE].nothingFound}
            </div>
          )}
        </div>
      ) : (
