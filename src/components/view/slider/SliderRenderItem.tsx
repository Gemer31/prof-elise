...
export function SliderRenderItem({ description, original }: ReactImageGalleryItem) {
  return (
    <div className="flex justify-center relative">
      <div className="absolute left-0 top-0 w-full h-full bg-black-1/4 z-10" />
      <ContentContainer styleClass="relative flex flex-col">
        ...
        <div className="absolute h-full top-0 bottom-0 flex justify-center flex-col z-20 mx-10">
          ...
          <Button styleClass="hidden md:block text-amber-50 px-6 py-4 w-fit" type={ButtonTypes.BUTTON}>
            {TRANSLATES[LOCALE].getDetails}
          </Button>
        </div>
      </ContentContainer>
    </div>
