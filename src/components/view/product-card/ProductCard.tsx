  ...
  return (
    ...
    >
      <div className="absolute flex flex-col gap-y-2 left-4 top-4">
        {data.labels?.map((item, index) => (
          <div
            ...
            key={index}
            className={
              'pointer-events-none w-fit px-2 py-1 rounded-md text-xs ' +
      ...
      <EntityFavouriteButton
        className="product-card-favourite-button absolute scale-0 top-4 right-4"
        productId={data.id}
      />
      <Image
      ...
      <div className="text-pink-500 bold my-2">
